...
class easypayBoletoModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        */
        ...
        Mail::Send(
            ...
            'boleto', // email template file to be use
            'Pagamento com Boleto Bancario - EASYPAY', // email subject
            array(
        ...
        $this->module->validateOrder(
            ...
            Configuration::get('EASYPAY_BB_WAIT'),
            (float) $this->context->cart->getOrderTotal(true, Cart::BOTH),
            'Boleto Bancario - EasyPay',
            null,
            null,
